                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start">
                                <div class="p-2 bg-pink-100 rounded-lg mr-3">
                                    <i class="fas fa-user-clock text-pink-600"></i>
                                </div>
                                <div>
    ...
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div class="overflow-hidden">
            ...
            <div class="p-12 text-center">
                ...
                <p class="text-gray-500 text-lg">Belum ada data kehadiran siswa</p>
            </div>
            <?php else: ?>
                ...
                <table class="w-full">
                    <thead class="bg-gray-100 border-b-2 border-gray-200">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-center text-xs font-bold text-gray-700 uppercase tracking-wider">Waktu</th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="text-sm font-semibold text-gray-700"><?= $detail['nis'] ?></span>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-bold text-gray-900"><?= $detail['nama_lengkap'] ?></div>
                                    </div>
                                </div>
                            </td>
