...
<div class="bg-white rounded-xl shadow p-6">
    ...
    <!-- Form -->
    <form action="<?= base_url('admin/siswa/update/' . $siswa['id']) ?>" method="POST" id="siswaForm">
        <?= csrf_field() ?>
                    ...
                    <div>
                        ...
                        <select name="kelas_id" 
                            ...
                            <?php foreach ($kelasList as $id => $kelas): ?>
                                <option value="<?= $id ?>" <?= old('kelas_id', $siswa['kelas_id']) == $id ? 'selected' : '' ?>>
                                    <?= esc($kelas) ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div>
                        ...
                        <select name="tahun_ajaran" 
                            ...
                            <?php foreach ($tahunAjaranList as $tahun): ?>
                                <option value="<?= $tahun ?>" <?= old('tahun_ajaran', $siswa['tahun_ajaran']) == $tahun ? 'selected' : '' ?>>
                                    <?= $tahun ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
