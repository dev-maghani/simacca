...
<div class="p-6">
    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Tambah Jadwal Mengajar</h1>
        <p class="text-gray-600">Isi form untuk menambahkan jadwal mengajar baru</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form action="<?= base_url('admin/jadwal/simpan'); ?>" method="post" id="jadwalForm">
            <?= csrf_field(); ?>
                ...
                <div>
                    ...
                    <select id="tahun_ajaran"
                        ...
                        <?php foreach ($tahunAjaranList as $key => $value): ?>
                            <option value="<?= $key; ?>" <?= old('tahun_ajaran') == $key ? 'selected' : ''; ?>>
                                <?= $value; ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
